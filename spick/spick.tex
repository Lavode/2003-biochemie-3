\documentclass[a4paper,twocolumn,usegeometry,english,fontsize=5,DIV=28]{scrartcl}
...
\usepackage[bottom=0.75cm,left=1cm,right=1cm]{geometry}
...
\begin{description}
	...
	\item[\ce{Zn^{2+}} Finger] Längliche Loop, mit durch Cys/His koordiniertem
		\ce{Zn^{2+}} Atom. Häufig in Eukaryonten, selten in Prokaryonten.
...
\begin{description}
	...
	\item[Bsp Steroid-Rezeptoren] Steroid diffundiert in Zelle, bindet an
		...
		(\ce{Zn^{2+}} Finger), spezifische Hormon-Bindungsdomäne.
\end{description}
...
\begin{description}
	...
	\item[Iron response] IRP (iron response protein) bindet IRE (iron
		...
		von \ce{Fe} an IRP verhindert Bindung an IRE.
\end{description}
